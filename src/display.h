...
public:
    ...
    void showStatus(const char* line1, const char* line2 = nullptr, const char* line3 = nullptr, float fps = -1.0f);
    void showStatus(const char* line1, const char* line2, const char* line3, const char* line4);
    void showStatus(const String& line1, const String& line2 = String(), const String& line3 = String(), float fps = -1.0f);
    ...
    void drawOverlay(float fps, const char* status = nullptr, bool liveviewActive = false);
    void drawOverlay(float fps, const String& status, bool liveviewActive = false);
